	...
	<div class="clear"></div>
		...
		<div class="payment">
			...
			<img class="poster" alt="img" src="${movieschedule.mv_poster }">
				...
				<div>
				<c:if test="${movieschedule.ts_idx eq 1}">IMAX LASER</c:if>
				<c:if test="${movieschedule.ts_idx eq 2}">일반(3D)</c:if>
				<c:if test="${movieschedule.ts_idx eq 3} ||${movieschedule.ts_idx eq 4} ">일반(2D)</c:if>
				</div>
				<div>${movieschedule.th_kind }관</div>
				<div>2023-09-15(x)</div>
				<br>
